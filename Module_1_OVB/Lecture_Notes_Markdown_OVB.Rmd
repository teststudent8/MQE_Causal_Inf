...
\begin{split}
x_{2i}=\rho_0+\rho_1x_{1i}+\varepsilon_i, 
\end{split}
\end{equation}
...
$$
where heath is an rspondents subjective assesment of their health with 1 being very health and 5 being very unhealthy. 
