...
setwd("C://Users/Claire/Dropbox/MQE_CI_Fall2020/Lecture Notes/Lecture_Notes_OVB")
...
#loading CPS data
mydata<-read.csv("data/cps_clean.csv")
...
#loading the data
agg_data<-read_dta("data/IA_MI_merge040504.dta")
nrow(agg_data)
