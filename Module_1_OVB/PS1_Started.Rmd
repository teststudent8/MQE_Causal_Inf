...
5) go to github.com/name1_name2_name3/your_group_project and click on the "Clone or Download" button. In the terminal type `git clone` and copy the url it gives you
...
You should see that you have modified files that has not yet commited. 
...
**Now you are set up to work cooperatively on an assignment using GitHub. The remainder of this assignment consists of a simple coding and plotting exercise to practice these collaborative skills. **  
...
**Question 2: Write a chunk in which you regress $Y$ on $V_1$ only. Is your estimates of $\beta_1$ biased?**
