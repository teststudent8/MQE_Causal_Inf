...
3) Because some of the data files are large, some data files are zipped on the github page. Unzip these and place them in the cloned folder (you will need to do this if you wish to compile any of the files that call upon these datasets.
